...
const SomeWhatScooper = () => (
  <div className="somewhat-scooper">
    <h1 className='somelocal mt-4'>Somewhat Scooper</h1>
    <div className="card-list">
      {SomeWhatScooperData.map((card, index) => (
        <CardComponent
          key={index}
          imgSrc={card.imgSrc}
          title={card.title}
...
export default SomeWhatScooper;
